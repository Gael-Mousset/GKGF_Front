      ...
      >
        ...
        <form className="grid gap-6 p-5" onSubmit={handleSubmit(onSubmit)}>
          ...
          <fieldset className="grid gap-4">
            <legend className="text-lg font-semibold">Infos Principales</legend>
          ...
          <fieldset className="grid gap-4">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <div className="flex flex-col gap-2">
                ...
                <select className="input-type-console" {...register("format")}>
              ...
              <div className="flex flex-col gap-2">
                ...
                <select className="input-type-console" {...register("region")}>
              ...
              <div className="flex flex-col gap-2">
                ...
                <select className="input-type-console" {...register("signal")}>
